...
%         pcode=CodificadorCLC(entrada)
        ...
        switch num_falhas
            case 1
                flag='Erro em um bit'
                poserro=randi(44,1,1)%%posição do erro randomicamente escolhida
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%tabela1%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                ...
                vp=[-12 -11 -10 -1 1 10 11 12]; %%vp(round((length(vp)-1)*rand(1,1))+1) me dará um elemento aleatório que representaria a posição onde a matriz teria o segundo erro
